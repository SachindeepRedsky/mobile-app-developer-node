module.exports = function (model) {
    ...
    module.gusset = require('./admin/gussetController.js')(model,config);
    module.gussetBrand = require('./admin/brandGussetController.js')(model,config);
    module.gussetCampaign = require('./admin/campaignGussetController.js')(model,config);
